...
netevolve_data = np.load("experiment_data/baseline/complete/DBLP/attempt=0/proposed_attr_auc.npy")
m1_attr = netevolve_data.mean(axis=0)
std1_attr = netevolve_data.std(axis=0)

proposed_data = np.load("experiment_data/complete/DBLP/persona=5/proposed_attr_auc.npy")
