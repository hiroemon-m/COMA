...
#@profile
def execute_data(skiptime,attempt,persona_num,data_name,data_type,del_type):
    ##デバッグ用
    ...
    path_n = "optimize/{}/{}/t={}/{}/attempt={}/".format(data_type,data_name,skiptime,del_type,attempt)
  ...
  #パラメータ
    ...
    path_save = "experiment_data/{}/{}/t={}/{}/attempt={}/persona={}".format(data_type,data_name,skiptime,del_type,attempt,persona_num)
    ...
    for skiptime in [2,3,4]:
        ...
        for attempt in range(1):
            for i in persona_list:
                ...
                print(attempt,del_type)
                execute_data(skiptime,attempt,i,"NIPS","imcomplete",del_type)